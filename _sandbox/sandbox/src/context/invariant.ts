 ...
 *
 * No runtime invariant: a shelf is a tracked JSON file the owner writes and this subsystem only reads, and a
 * composition is one field on the registry entry, written once beside the worktrees it shaped. The relationship

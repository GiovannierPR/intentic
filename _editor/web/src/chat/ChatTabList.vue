...
import { FINISHED_WINDOW, type FleetAgent, windowFinished } from "../composables/agents/useAgents-fleet";
...
import type { RevealVerb } from "../composables/chat/useChat-reveal";
